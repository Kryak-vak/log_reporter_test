...
from src.common_types import log_value_type


class LogReader:
    accepted_file_types = ('.log', )
    ...
    def read_one(self) -> Iterator[dict[str, log_value_type]]:
        for file_path in self.file_paths:
            with open(file_path, "r", encoding="utf-8") as file:
                for line in file:
                    line_data: dict[str, log_value_type] = json.loads(line)
                    yield line_data
